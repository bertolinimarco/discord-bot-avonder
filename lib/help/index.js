...
const helpPrivate = () => `Puoi scrivermi comandi in privato utilizzando \`Avonder segreto <comando>
\`\`\`
Avonder segreto tira 1d20+2   - Tiro 1d20+2 e ti scrivo in privato
\`\`\`
...
const handler = (params /*, author, guildId */) => {
  ...
  return `
  Bentrovato viandante, in cosa posso esserti utile?\nScrivi l'argomento con \`Avonder aiuto <argomento>\`\n\n Argomenti: ${[
    ...helpTopics.keys()
  ]
    .map(topic => `\`${topic}\``)
    .join(", ")}
