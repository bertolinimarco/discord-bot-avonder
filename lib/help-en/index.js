...
\`1d8-1d4\` Roll 1d8 and subtract 1d4 (you can use also _multiply_ and _divide_ operators)
...
\`2w6w8\` Roll 2d6 _wild_ and a 1d8 _wild_
...
\`3d6!m2\` _explode_ max 2 times for each d6 (also, max 5 times in a row, but it's rare...)

_Combine_
\`2d20!l\` Roll 2d20 _exploding_ dices and keep the lowest result

_Comment_
\`1d20+1#to hit, 1d8#long sword\` Tiro 1d20 to hit, then 1d8 for long sword damage
\`1d20+12#Make an "Athletics" check \` :muscle:
