...
const generateNPC = () => {
  ...
  return `**${getNPCName}** - ${getRandomNPCPhysical.text}, ${getRandomNPCTrait.text} e ${getRandomNPCItem.text}`;
};
...
const generateRiddle = () => {
  const riddlesTable = [
    {
      ID: 1,
      text: "Ha la testa dorata, la coda d'oro. Non ha corpo. [Moneta d'oro]"
    },
    {
      ID: 2,
      text:
    ...
    {
      ID: 7,
      text: "Meglio vecchia che giovane, più sana è, più piccola è. [Ferita]"
    },
    {
      ID: 8,
      text:
