...
const generateNPC = () => {
  ...
  const npcItemTable = [
    { ID: 1, text: "10 metri di corda resistente" },
    { ID: 2, text: "una sacca con alcune candele" },
    { ID: 3, text: "una vecchia lanterna di rame" },
    { ID: 4, text: "alcuni fogli di carta" },
    { ID: 5, text: "una calda coperta decorata" },
    { ID: 6, text: "una pozione di guarigione" },
    { ID: 7, text: "due pozioni di guarigione" },
    { ID: 8, text: "tre pozioni di guarigione" },
    { ID: 9, text: "un paio di pozioni dalla forma strana" },
    { ID: 10, text: "una scatola di fiammiferi" },
    { ID: 11, text: "una spada arrugginita" }
  ];
  ...
  return `**${getRandomNPCName1.text}${getRandomNPCName2.text}** - ${getRandomNPCPhysical.text}, ${getRandomNPCTrait.text}, trasporta ${getRandomNPCItem.text}`;
};
  ...
  const booksTable = [
    {
      ID: 1,
      text:
        "**101 modi per cucinare una gelatina** – Una raccolta di ricette interessanti tra cui un cocktail creato da un Cubo Gelatinoso, Mela con Melma Ocra e pudding salato"
    },
    {
      ID: 2,
      text:
        "**Fisiologia delle Creature Magiche** – Informazioni sulla fisiologia di Beholders, Draghi, Unicorni e altri. E' pieno di diagrammi."
    },
    {
      ID: 3,
      text:
        "**Le Profezie** – Racconti di grande avventura. Dopo un po' però, le pagine diventano bianche..."
    },
    {
      ID: 4,
      text:
        "**Come individuare un Mimic** – Consigli tra cui _ascoltare il respiro degli oggetti_, e verificare se _rispondono al tocco_."
    },
    {
      ID: 5,
      text: "**La Fantastica Avventura di Bordrick** – Un librogame nanico"
    },
    {
      ID: 6,
      text:
        "**Fra i Piani** – Illustra diversi modi di viaggiare attraverso i Piani di esistenza."
    },
    {
      ID: 7,
      text:
        "**Delle Razze Mostruose** – Un trattato che si occupa di stabilire se le razze _mostruose_ debbano o meno essere considerate al pari delle razze _civilizzate_."
    },
    {
      ID: 8,
      text:
        "**Quelli-di-fuori** – Uno strano diario personale di qualcuno che ha avuto una visione di sé come piccola statuina di plastica su un tavolo, accerchiata da una serie di figure simili a divinità che parlavano come se interpretassero un gruppo di avventurieri."
    },
    {
      ID: 9,
      text:
        "**Umano?** – La storia di un ogre che, anche se stupido, riesce a convincere tutti di essere in realtà un umano molto alto, che è diventato Re, successivamente scoperto e infine giustiziato."
    },
    {
      ID: 10,
      text:
        "**Luoghi da visitare prima di morire** – Illustra un numero imprecisato di luoghi e monumenti, di una regione che non hai mai sentito nominare."
    }
  ];
