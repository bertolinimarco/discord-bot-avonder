...
const handler = () => {
  ...
  **Roll dices**\n\`Avonder roll <x>\` or \`!r <x>\`
  ...
  \`1d8-1d4\` Roll 1d8 and subtract 1d4 (you can use \`+ - * /\`)
  ...
  **Draw Cards**\n\`Avonder cards <n>\` or \`!c <x>\`
  ...
  \`cards\` Draw a card from _base_ deck.
  \`5\` Draw 5 cards from _base_ deck.
  ...
  \`shuffle <deckname>\` Shuffle <deckname>
  \`remove <deckname>\` Remove <deckname> from channel
